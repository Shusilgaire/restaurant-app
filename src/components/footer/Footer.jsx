  ...
  return <footer className='footer'>
      ...
      <Container>
        <Row>
          ...
          <ListGroup>
            ...
            <i class="ri-map-pin-line"></i> Omiya, Saitama{" "}
            </ListGroupItem>

            <ListGroupItem className='link__item d-flex align-items-center gap-3'> 
            <i class="ri-mail-line"></i> delhidurbar229@gmail.com{" "}
            </ListGroupItem>

            <ListGroupItem className='link__item d-flex align-items-center gap-3'> 
            <i class="ri-phone-line"></i> +81 123 456 789
            </ListGroupItem>
    ...
    <div className='footer__bottom'>
      <Container>
        <Row>
          <Col lg='12'>
            <p>Copyright 2023, Developed by shusil.</p>
          </Col>
        </Row>
      </Container>
    </div>
